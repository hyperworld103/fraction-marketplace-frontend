...
contract Collection is Ownable, ERC721
{
	...
	constructor (string memory _name, string memory _symbol, address _to) ERC721(_name, _symbol)
	{
...
contract CollectionFactory
{
	...
	{
		_collectionAddress =  _createCollection(_name, _symbol, address(this));
	...
	{
		_collectionAddress =  _createCollection(_name, _symbol, _to);
        return _collectionAddress;
	}
    ...
    function getCollectionAddress() public view returns (address _collection) {
        return _collectionAddress;
    }
